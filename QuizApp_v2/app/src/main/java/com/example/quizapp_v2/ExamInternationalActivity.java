...
public class ExamInternationalActivity extends AppCompatActivity implements ExamCustomAdapter.OnNoteListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exam_international);

        dbHelper = new DbHelper(ExamInternationalActivity.this);
...
//        Toast.makeText(getApplicationContext(), " "+ dbHelper.getRowCount(), Toast.LENGTH_LONG).show();
        ...
        examCustomAdapter = new ExamCustomAdapter(ExamInternationalActivity.this, this, id, question, answer, optionOne, optionTwo, optionThree, optionFour);
        recyclerView.setAdapter(examCustomAdapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(ExamInternationalActivity.this));

    }

    void storeDataInArray(){
        Cursor cursor = dbHelper.readAllDataInternational();
