...
public class ExamScienceActivity extends AppCompatActivity implements ExamCustomAdapter.OnNoteListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exam_science);

        dbHelper = new DbHelper(ExamScienceActivity.this);
...
//        Toast.makeText(getApplicationContext(), " "+ dbHelper.getRowCount(), Toast.LENGTH_LONG).show();
        ...
        examCustomAdapter = new ExamCustomAdapter(ExamScienceActivity.this, this, id, question, answer, optionOne, optionTwo, optionThree, optionFour);
        recyclerView.setAdapter(examCustomAdapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(ExamScienceActivity.this));
    }
