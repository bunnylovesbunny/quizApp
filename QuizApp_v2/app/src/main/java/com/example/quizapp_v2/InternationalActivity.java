...
public class InternationalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHelper = new DbHelper(InternationalActivity.this);
        ...
        customAdapter = new CustomAdapter(InternationalActivity.this, id, question, answer);
        recyclerView.setAdapter(customAdapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(InternationalActivity.this));
