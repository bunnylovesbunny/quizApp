...
public class BangladeshActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHelper = new DbHelper(BangladeshActivity.this);
        ...
        customAdapter = new CustomAdapter(BangladeshActivity.this, id, question, answer);
        recyclerView.setAdapter(customAdapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(BangladeshActivity.this));
