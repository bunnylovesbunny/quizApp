...
public class ExamSportsActivity extends AppCompatActivity implements ExamCustomAdapter.OnNoteListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exam_sports);

        dbHelper = new DbHelper(ExamSportsActivity.this);
...
//        Toast.makeText(getApplicationContext(), " "+ dbHelper.getRowCount(), Toast.LENGTH_LONG).show();
        ...
        examCustomAdapter = new ExamCustomAdapter(ExamSportsActivity.this, this, id, question, answer, optionOne, optionTwo, optionThree, optionFour);
        recyclerView.setAdapter(examCustomAdapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(ExamSportsActivity.this));
    }

    void storeDataInArray(){
        Cursor cursor = dbHelper.readAllDataSports();
