...
public class ExamFilmActivity extends AppCompatActivity implements ExamCustomAdapter.OnNoteListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exam_film);

        dbHelper = new DbHelper(ExamFilmActivity.this);
...
//        Toast.makeText(getApplicationContext(), " "+ dbHelper.getRowCount(), Toast.LENGTH_LONG).show();
        ...
        examCustomAdapter = new ExamCustomAdapter(ExamFilmActivity.this, this, id, question, answer, optionOne, optionTwo, optionThree, optionFour);
        recyclerView.setAdapter(examCustomAdapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(ExamFilmActivity.this));

    }

    void storeDataInArray(){
        Cursor cursor = dbHelper.readAllDataFilm();
