...
public class ExamBangladeshActivity extends AppCompatActivity implements ExamCustomAdapter.OnNoteListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exam_bangladesh);

        dbHelper = new DbHelper(ExamBangladeshActivity.this);
...
//        Toast.makeText(getApplicationContext(), " "+ dbHelper.getRowCount(), Toast.LENGTH_LONG).show();
        ...
        examCustomAdapter = new ExamCustomAdapter(ExamBangladeshActivity.this, this, id, question, answer, optionOne, optionTwo, optionThree, optionFour);
        recyclerView.setAdapter(examCustomAdapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(ExamBangladeshActivity.this));

    }

    void storeDataInArray(){
        Cursor cursor = dbHelper.readAllDataBangladesh();
