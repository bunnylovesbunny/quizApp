...
public class FilmActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHelper = new DbHelper(FilmActivity.this);
        ...
        customAdapter = new CustomAdapter(FilmActivity.this, id, question, answer);
        recyclerView.setAdapter(customAdapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(FilmActivity.this));
